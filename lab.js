...
if(temperature >= 80 && rain === true){
  ...
  console.log("No rain today, but shorts and a t-shirt are recommended")
}else if (temperature > 60 && temperature < 80 && rain === false){
  console.log("No rain today, but a light jacket is recommended for the day")
}else if(temperature <= 60){
  console.log("No rain today, but dress warm a coat is recommended")
}else{
  console.log("No weather today the world has ended")
}
////////// PROBLEM 5 //////////
